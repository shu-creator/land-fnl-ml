...
[レビュー観点]
1. 禁則ワード（座席, 並び席, 保険, 返金, 金銭, 旅券, JR, 社内進行）が JSON に含まれていないか。
2. 原文に「ハネムーン, 入籍予定, 記念日」などの表現がある場合、celebration フィールドに正しく反映されているか。
3. アレルギー情報が meal_allergy または medical に正しく配置されているか。
4. 不自然な重複, 明らかな誤読がないか。
